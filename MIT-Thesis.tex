...
%% use \parencite, not \c% Add keywords that will help search engines and libraries to find your work.
	% Includes the name[s] of the author[s] 
	% (If you used \DocumentMetadata at line 14, you can just put "\CopyrightAuthor," for the names.)ite, when you want "(Author, year)"
...
\hypersetup{%
	pdfsubject={Full simualtion of kilonova light curves from neutron star mergers},
	% Change this to briefly state topic of your thesis 
% 
	pdfkeywords={Neutron star mergers, kilonovae, light curves, nuclear physics, astrophysics, numerical simulations},
...
\title{End-to-end modeling of kilonova light curves and waveforms from neutron star mergers and its possible constraints on nuclear physics parameters}

 \Author{Diego Fernando Hernández Porras}{Department of Physics}

\Degree{Master of Science in Physics}{Department of Physics}


 \Supervisor{Neelima Govind Kelkar}{Professor of Physics}[Department of Physics]

\Acceptor{None}{none}{} % \\ & Third title}


% Date degree will be issued: \DegreeDate{Month}{year}
% Valid degree months are February, May, June, or September
\DegreeDate{december}{2026}


% Date that final thesis is submitted to department
\ThesisDate{December, 2026}
...
\include{Introduction}% .tex extension is presumed
\include{Multimenssengers_physics}
\include{Kilonova_light_curves}
\include{Results}
